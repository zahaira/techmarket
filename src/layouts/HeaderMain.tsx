      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 px-4">
        <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-start">
          ...
          <button
            ...
            className="sm:hidden flex items-center justify-center w-10 h-10 bg-primary-main text-white rounded-full shadow-md"
          >
          ...
          <Link
            href="/"
            className="text-2xl sm:text-3xl font-bold text-light flex items-center"
          >
            Tech<span className="text-light ml-1">Market</span>
          </Link>
