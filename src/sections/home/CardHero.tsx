    ...
    >
      <div className="flex flex-col gap-2">
        ...
        {product.discountPercentage && (
          <span className=" text-primary-main px-2 py-1 text-3xl rounded-2xl w-max font-semibold ">
        ...
        <span
          className="inline-block bg-white text-3xl md:text-3xl text-primary-main font-bold px-4 py-2 rounded-2xl shadow-md w-max"
